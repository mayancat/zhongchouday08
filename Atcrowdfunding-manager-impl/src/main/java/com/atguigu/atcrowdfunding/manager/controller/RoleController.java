...
public class RoleController extends BaseController {
	 ...
	 * @ResponseBody
	 * 
	 * @RequestMapping("/batchDelete") public Object batchDelete(Integer[] ids){
	 * AjaxResult result = new AjaxResult(); try { int count =
	 * roleService.batchDeleteRole(ids); if(count==ids.length){
	 * result.setSuccess(true); }else{ result.setSuccess(false); } } catch
	 * (Exception e) { e.printStackTrace(); result.setSuccess(false); }
	 * 
	 * return result; }
	 */
